...
function M.myColors()
  -- execute("hi! VertSplit   guibg="..vim.g.colors.screen)
  execute("hi! SignColumn  guibg="..vim.g.colors.screen)
  execute("hi! FoldColumn  guibg="..vim.g.colors.screen)
  execute("hi! DiffAdd     guifg="..vim.g.colors.green)
  execute("hi! DiffAdd     guibg="..vim.g.colors.screen)
  execute("hi! DiffChange  guifg="..vim.g.colors.yellow)
  execute("hi! DiffChange  guibg="..vim.g.colors.screen)
  execute("hi! DiffDelete  guifg="..vim.g.colors.red)
  execute("hi! DiffDelete  guibg="..vim.g.colors.screen)

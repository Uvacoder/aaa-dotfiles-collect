...
_G.packer_plugins = {
  ["bufdelete.nvim"] = {
    loaded = true,
    path = "/Users/sldobri/.local/share/nvim/site/pack/packer/start/bufdelete.nvim"
  },
  ["diffview.nvim"] = {
    loaded = true,
  ...
  nvim_context_vt = {
    loaded = true,
    path = "/Users/sldobri/.local/share/nvim/site/pack/packer/start/nvim_context_vt"
  },
  ["packer.nvim"] = {
    loaded = true,
  ...
  ["vim-svg-indent"] = {
    loaded = true,
    path = "/Users/sldobri/.local/share/nvim/site/pack/packer/start/vim-svg-indent"
  },
  ["vim-visual-multi"] = {
    loaded = true,

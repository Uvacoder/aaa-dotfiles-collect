...
_G.packer_plugins = {
  ...
  ["autoclose.nvim"] = {
    loaded = true,
    path = "/Users/sldobri/.local/share/nvim/site/pack/packer/start/autoclose.nvim",

...
_G.packer_plugins = {
  ["battery.vim"] = {
    config = { "\27LJ\2\nı\b\0\0\3\0\r\0\0296\0\0\0009\0\1\0'\2\2\0B\0\2\0016\0\0\0009\0\1\0'\2\3\0B\0\2\0016\0\0\0009\0\1\0'\2\4\0B\0\2\0016\0\0\0009\0\5\0'\1\a\0=\1\6\0006\0\0\0009\0\5\0'\1\t\0=\1\b\0006\0\0\0009\0\5\0'\1\v\0=\1\n\0006\0\0\0009\0\5\0)\1\5\0=\1\f\0K\0\1\0\24battery#graph_width\5\31battery#symbol_discharging\bÔëÑ\28battery#symbol_charging\f%v%% %s\29battery#component_format\6g¨\2          fun! Battery_icon_low()\n            let l:battery_icon = { 4: \"\", 3: \"\", 2: \"\", 1: \"\", 0: \"Ôïπ\" }\n            let l:backend = battery#backend()\n            let l:nf = float2nr(round(backend.value / 20.0))\n            return printf('%s', get(battery_icon, nf))\n          endfun\n        ≠\2          fun! Battery_icon_warn()\n            let l:battery_icon = { 4: \"\", 3: \"\", 2: \"\", 1: \"Ôïª\", 0: \"\" }\n            let l:backend = battery#backend()\n            let l:nf = float2nr(round(backend.value / 20.0))\n            return printf('%s', get(battery_icon, nf))\n          endfun\n        ≥\2          fun! Battery_icon_full()\n            let l:battery_icon = { 4: \"Ôï∏\", 3: \"Ôïø\", 2: \"ÔïΩ\", 1: \"\", 0: \"\" }\n            let l:backend = battery#backend()\n            let l:nf = float2nr(round(backend.value / 20.0))\n            return printf('%s', get(battery_icon, nf))\n          endfun\n        \bcmd\bvim\0" },
    loaded = true,
